...
export default class P2G_creacionFolioGlobalRouting extends LightningModal {
    isProduccion = true;
    ...
    @track idFolios;
    @track grupo = 'SP-R-GLOBAL ROUTING';
    @track numfolios = 1;
    formulario = true;
    resumen = false;
    newCargoLine = false;
...
// guardar Registro
    ...
    registroFreightMode(event){
        ...
        if(this.valueFreightMode === 'SEA'){
            this.wrapperFolio.serviceMode = 'IMPORT';
            this.valueServiceMode = 'IMPORT';
            this.valueServiceType = '';
            this.modeSea = true;
            this.modeRoad = false;
            this.modeAir = false;
        }else if(this.valueFreightMode === 'ROAD'){
            this.modeRoad = true;
            this.modeSea = false;
            this.modeAir = false;
