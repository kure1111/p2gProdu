...
export default class P2G_creacionFolioPuertos extends LightningModal {
    isProduccion = true;
...
//Variables para busqueda
    ...
    searchValueIdClaveUnidadPeso = this.idClaveUnidadPeso;
