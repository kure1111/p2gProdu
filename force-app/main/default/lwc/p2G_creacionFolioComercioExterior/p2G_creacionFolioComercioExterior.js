...
export default class P2G_creacionFolioComercioExterior extends LightningModal{
    isProduccion = true;
    ...
    @track idFolios;
    @track grupo = 'SP-CE-COMERCIO EXT';
    @track numfolios = 1;
    formulario = true;
    resumen = false;
    newCargoLine = false;
...
// botones de opciones
    ...
    valueCurrency = 'MXN';
    //valores Freight_Mode__c
    get optionsFreightMode() {
        return [
    ...
    get optionsServiceModeSea() {
        return [
            { label: 'IMPORT', value: 'IMPORT' },
            { label: 'EXPORT', value: 'EXPORT' },
        ];
    }
    get optionsServiceModeAir() {
        return [
            { label: 'IMPORT', value: 'IMPORT' },
            { label: 'EXPORT', value: 'EXPORT' },
            { label: 'NATIONAL', value: 'NATIONAL' },
    ...
    get optionsServiceTypeSea() {
        return [
            { label: 'FCL', value: 'FCL' },
            { label: 'LCL', value: 'LCL' },
        ];
    }
    get optionsServiceTypeAir() {
        return [
...
// guardar Registro
    ...
    registroTeam(event){
        this.valueTeam = event.target.value;
    }
    registroFreightMode(event){
        this.wrapperFolio.freighMode = event.target.value;
        this.valueFreightMode = event.target.value;
        if(this.valueFreightMode === 'Road'){
            this.siRoad = true;
            this.siAir = false;
            this.siSea = false;
            this.valueServiceMode = '';
            this.valueServiceType = '';

        }else if (this.valueFreightMode === 'Sea'){
            this.siSea = true;
            this.siRoad = false;
            this.siAir = false;
            this.valueServiceMode = '';
            this.valueServiceType = '';
        }else if (this.valueFreightMode === 'Air'){
            this.siAir = true;
            this.siSea = false;
            this.siRoad = false;
            this.valueServiceMode = '';
    ...
    registroPadronImpak(event){
        this.wrapperFolio.impak = event.target.value;
    }
    registroServicioIMPAK(event){
        this.wrapperFolio.servicioIMPAK = event.target.value;
    }
    registroSalesIncoterm(event){
        this.wrapperFolio.salesIncoterm = event.target.value;
    }
...
//metodos
    ...
    camposRequeridos(){
        const requiredFields = [
            this.wrapperFolio.freighMode,
            this.wrapperFolio.serviceMode,
            this.wrapperFolio.servicetype,
            this.wrapperFolio.impak,
            this.wrapperFolio.servicioIMPAK,
            this.wrapperFolio.salesIncoterm,
