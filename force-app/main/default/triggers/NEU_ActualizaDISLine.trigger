...
trigger NEU_ActualizaDISLine on Disbursement_Line__c (before insert, before update)
{
    ...
    else if(trigger.isUpdate == true){for(Disbursement_Line__c line : trigger.new){Disbursement_Line__c old_line = Trigger.oldMap.get(line.Id);line.Name = old_line.Name;}}
}