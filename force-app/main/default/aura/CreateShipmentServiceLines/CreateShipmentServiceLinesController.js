({
    ...
    createRecord : function (component, event, helper) {
        ...
        if(shipment.Shipment_Type__c  == "FN" && (shipment.Account_for__c == "0010R000019aZF8QAM" || shipment.Account_for__c == "0014T000005QxaZQAS"))
            recordID = (shipment.Account_for__c == "0010R000019aZF8QAM" ? "0120R000003Qo7wQAC" : "0124T000000Q3VdQAK" );
        
        createRecordEvent.setParams({
            "entityApiName": "Fee__c",
             "recordTypeId": recordID,
            "defaultFieldValues": {
                'Account_for__c' : shipment.Account_for__c,
                'Route__c': shipment.Route__c,
                'Active__c': true
            },
    ...
    onInit : function(component, event, helper) {
        ...
        component.set('v.servicelinescolumns', [
            ...
            {label: 'Sell Price', fieldName: 'Shipment_Sell_Price__c', initialWidth: 120, type: 'currency', typeAttributes: { currencyCode: { fieldName: 'CurrencyIsoCode' }}},
            ...
            {label: 'Std. Buy Price', fieldName: 'Shipment_Buy_Price__c', initialWidth: 120, type: 'currency', typeAttributes: { currencyCode: { fieldName: 'CurrencyIsoCode' }}},
        ...
        helper.cargarShipment(component, event);
